...
def some_public_function(x: int):
    print("[perceptive_humanoid_parkour] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[perceptive_humanoid_parkour] startup")
    ...
    def on_shutdown(self):
        print("[perceptive_humanoid_parkour] shutdown")